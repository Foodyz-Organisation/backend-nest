...
export class SignupDto {
    ...
    // --- MODIFIED: phone and address are now REQUIRED ---
    @ApiProperty({ description: 'Phone number of the user', example: '+1234567890' }) // Removed ApiPropertyOptional
    @IsString() // Add validation decorator
    @IsNotEmpty() // Add validation decorator
    phone: string; // Removed '?' to make it required
